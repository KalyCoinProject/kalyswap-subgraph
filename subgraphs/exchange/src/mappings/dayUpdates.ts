...
import { Pair, Bundle, Token, KalyswapFactory, KalyswapDayData, PairDayData, TokenDayData } from '../types/schema'
import { ONE_BI, ZERO_BD, ZERO_BI, FACTORY_ADDRESS } from './helpers'

export function updateKalyswapDayData(event: EthereumEvent): KalyswapDayData {
  ...
  if (kalyswapDayData === null) {
    ...
    kalyswapDayData.dailyVolumeUSD = ZERO_BD
    kalyswapDayData.dailyVolumeETH = ZERO_BD
    kalyswapDayData.totalVolumeUSD = ZERO_BD
    kalyswapDayData.totalVolumeETH = ZERO_BD
    kalyswapDayData.dailyVolumeUntracked = ZERO_BD
  }

  kalyswapDayData.totalLiquidityUSD = kalyswap.totalLiquidityUSD
  kalyswapDayData.totalLiquidityETH = kalyswap.totalLiquidityETH
