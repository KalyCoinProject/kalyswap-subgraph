...
import { getKLCPriceInUSD, findEthPerToken, getTrackedVolumeUSD, getTrackedLiquidityUSD } from './pricing'
import {
...
let MINING_POOLS: string[] = [
  '0xdbfd50b15ce8249ae736ceb259927e77fec231bf', // MiniChefV2

  "0x8fd2755c6ae7252753361991bdcd6ff55bdc01ce", // v1 WKLC-KSWAP

  '0x574d3245e36cf8c9dc86430eadb0fdb2f385f829', // v2 WKLC-KSWAP
]
...
export function handleTransfer(event: Transfer): void {
  ...
  //let factory = KalyswapFactory.load(FACTORY_ADDRESS) // Is this needed?
...
export function handleSync(event: Sync): void {
  ...
  kalyswap.totalLiquidityETH = kalyswap.totalLiquidityETH.minus(pair.trackedReserveETH as BigDecimal)
  ...
  bundle.ethPrice = getKLCPriceInUSD(event.block.number)
  bundle.save()
  ...
  kalyswap.totalLiquidityETH = kalyswap.totalLiquidityETH.plus(trackedLiquidityETH)
  kalyswap.totalLiquidityUSD = kalyswap.totalLiquidityETH.times(bundle.ethPrice)
...
export function handleSwap(event: Swap): void {
  ...
  kalyswap.totalVolumeETH = kalyswap.totalVolumeETH.plus(trackedAmountETH)
  ...
  kalyswapDayData.dailyVolumeETH = kalyswapDayData.dailyVolumeETH.plus(trackedAmountETH)
